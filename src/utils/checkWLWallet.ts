...
// ) */
// const TOKEN_PUBKEY = new PublicKey('TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA');

// //export async function getNft()

// export const checkWLToken = async (connection: Connection, userAddress: any, wltTokenAddress: any): Promise<any> => {
//     try {
...
//             filters: getFilter,
//         };
//         let _listOfTokens = await connection.getProgramAccounts(TOKEN_PUBKEY, programAccountsConfig);
